        ...
        >
          {this.state.recordsToday < 10 ? (
            ...
            <Text
              style={{ textAlign: "center", fontSize: 20, marginBottom: 30 }}
            >
              Chill out my dude, I need to analyze the data and will send you a
        ...
        {this.state.isSubmitted ? (
          ...
          <View>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => {
                  this._onPressEnergy("motivation")
                }}
              >
                <View
                  style={{
            ...
            <View style={{ alignItems: "center", marginTop: 30 }}>
              ...
              >
                <Text style={{ fontSize: 24, color: "#7200FF" }}>Submit</Text>
              </TouchableOpacity>
            </View>
          </View>
        ) : (
